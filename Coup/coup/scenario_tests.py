...
def steal_test():
    ...
    actions = [env.get_action_id("steal"), env.get_action_id("counteract"), env.get_action_id("pass"), env.get_action_id("income"), env.get_action_id("pass"), env.get_action_id("pass")]
